...
def mean_sylethi(paths):
    ...
    for i in os.listdir(paths):
        if '_0' in i:
            image0.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_1' in i:
            image1.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_2' in i:
            image2.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_3' in i:
            image3.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_4' in i:
            image4.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_5' in i:
            image5.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_6' in i:
            image6.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_7' in i:
            image7.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_8' in i:
            image8.append(np.asarray(Image.open(paths+'\\' +i)))
        if '_9' in i:
            image9.append(np.asarray(Image.open(paths+'\\' +i)))
    for j in image0:
        mean0+=j/len(image0)
    for j in image1:
        mean1+=j/len(image1)
